        ...
        .full(@click='incrementSlide')
          hooper.sliderclass(ref="hooper" :settings='hooperSettings' @slide='incrementCount($event)')
            slide(v-for="(slide, index) in slideObject.slideCount")
                .ctrimg(v-if="(slideObject.ext[index] != 'mp4')" index)
...
export default {
  ...
  data () {
    return {
      ...
      slideObject: {
        slideCount: 16,
        ext: ['mp4', 'jpg', 'mp4', 'jpg', 'mp4', 'mp4', 'jpg', 'jpg', 'mp4', 'jpg', 'jpg', 'mp4', 'mp4', 'jpg', 'jpg', 'jpg'],
        icon: ['social', 'social', 'concept', 'web', 'id', 'id', 'id', 'print', 'print', 'print', 'gather', 'id', 'gather', 'id', 'id', 'id']
      },
      hooperSettings: {
        itemsToShow: 1,
        centerMode: true,
